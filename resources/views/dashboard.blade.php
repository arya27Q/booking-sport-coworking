            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="bg-white rounded-[2.5rem] overflow-hidden border border-gray-100 shadow-sm group hover:shadow-xl transition-all duration-300">
                    <div class="relative h-52 overflow-hidden">
                        <img src="https://images.unsplash.com/photo-1763775594018-4a84eeadd83d?w=600&auto=format&fit=crop&q=60" class="w-full h-full object-cover group-hover:scale-105 transition duration-500">
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div class="flex justify-between items-center pt-4">
                            ...
                            <a href="#" class="bg-[#4F46E5] text-white px-6 py-2.5 rounded-2xl text-sm font-bold active:scale-95 shadow-lg shadow-indigo-100">Booking</a>
                        </div>
                    </div>
                </div>
                </div>
